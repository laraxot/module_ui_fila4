    ...
    <div class="relative mx-auto max-w-lg divide-y-2 divide-gray-200 lg:max-w-7xl">
      ...
      <div class="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-12">
        <div>
          <div>
            <a href="#" class="inline-block">
              <span class="inline-flex items-center rounded-full px-3 py-0.5 text-sm font-medium bg-indigo-100 text-indigo-800">Article</span>
            </a>
          </div>
        ...
        <div>
          <div>
            <a href="#" class="inline-block">
              <span class="inline-flex items-center rounded-full px-3 py-0.5 text-sm font-medium bg-green-100 text-green-800">Case Study</span>
            </a>
          </div>
          <a href="#" class="mt-4 block">
