...
```
/var/www/html/<directory progetto>/
...
|---------------|---------------------|-------------------|
| Immagini | `/var/www/html/<directory progetto>/public_html/images/` | `/var/www/html/<directory progetto>/laravel/public/images/` |
| CSS | `/var/www/html/<directory progetto>/public_html/css/` | `/var/www/html/<directory progetto>/laravel/public/css/` |
| JavaScript | `/var/www/html/<directory progetto>/public_html/js/` | `/var/www/html/<directory progetto>/laravel/public/js/` |
| SVG | `/var/www/html/<directory progetto>/public_html/images/` | `/var/www/html/<directory progetto>/laravel/public/images/` |
...
```
/var/www/html/<directory progetto>/laravel/Themes/One/resources/views/components/ui/
```
...
```
/var/www/html/<directory progetto>/public_html/images/
```
...
```
/var/www/html/<directory progetto>/laravel/Themes/One/resources/views/components/ui/avatar.blade.php
```

E utilizza gli avatar SVG dalla directory pubblica:

```
/var/www/html/<directory progetto>/public_html/images/avatars/
```
...
```
/var/www/html/<directory progetto>/laravel/Themes/One/resources/views/components/ui/icon.blade.php
```
...
1. **Utilizzo del percorso Laravel public**: Utilizzare `/var/www/html/<directory progetto>/laravel/public/` invece di `/var/www/html/<directory progetto>/public_html/`
