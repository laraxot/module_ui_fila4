...
> **IMPORTANTE**: MAI utilizzare `/var/www/html/<directory progetto>/laravel/public/` per i file pubblici. Questa cartella non è accessibile via web nel setup di <main module>.

## Tipi di Risorse

### Immagini

Le immagini devono essere posizionate in `/var/www/html/<directory progetto>/public_html/images/` e organizzate in sottocartelle per tipologia:
...
Seguendo queste linee guida per la gestione delle risorse pubbliche, si garantisce che tutte le risorse siano correttamente accessibili via web e organizzate in modo coerente, facilitando la manutenzione e l'evoluzione del progetto <main module>.
