...
- ❌ `<x-filament::layouts.app>` - Non esiste, utilizzare invece `<x-layouts.app>` di <main module>
...
2. **Per le pagine frontend**:
   - Creare file Blade in `/var/www/html/<directory progetto>/laravel/Themes/One/resources/views/pages/`
